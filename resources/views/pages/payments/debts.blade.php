...
{{--
                                ...
                                <div class="btn-group">
                                    <button type="button" class="btn btn-primary" onclick="payOrder({{ $order->id }})"><i class="mdi mdi-cash me-1"></i></button>
                                    <a href="{{ route('orders.show', $order->id) }}" class="btn btn-success"><i class="mdi mdi-eye me-1"></i></a>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="order_summa" name="order_summa" placeholder="Сумма" required readonly>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="mb-3">
